...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="ArtisAlbumsList" runat="server" AutoGenerateColumns="False" DataSourceID="ArtisAlbumsListODS">
        <Columns>
    ...
    <asp:ObjectDataSource ID="ArtisAlbumsListODS" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Albums_GetArtistAlbums" TypeName="ChinookSystem.BLL.AlbumController"></asp:ObjectDataSource>
</asp:Content>
