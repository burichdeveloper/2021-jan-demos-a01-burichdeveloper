...
using ChinookSystem.ViewModels; // is for the public data classes 
                    //for transporting data from the library to the web application
...
namespace ChinookSystem.BLL
{
    ...
    public class ArtistController
    {
        ...
        public List<SelectionList> Artists_DDL_List()
        {
